    ...
    <section className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-2 md:gap-3">
        ...
        <div className="rounded-lg border border-rose-300 bg-rose-50/80 p-3">
          ...
          <p className="text-xl font-semibold text-rose-900">{(summary.totalExpenseCents / 100).toFixed(2)}</p>
        </div>
        <div className="rounded-lg border border-sky-300 bg-sky-50/80 p-3">
          <p className="text-xs text-sky-700">Caisse actuelle</p>
          <p className="text-xl font-semibold text-sky-900">{(summary.caisseCents / 100).toFixed(2)}</p>
        </div>
      </div>
